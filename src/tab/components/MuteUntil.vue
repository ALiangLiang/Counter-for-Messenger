...
export default {
  ...
  data () {
    ...
    return {
      ...
      pickerOptions: {
        ...
        shortcuts: [
          { text: 'Unmute', onClick: (picker) => ce(picker, 0) },
          { text: '30 minutes', onClick: (picker) => ce(picker, 30) },
          { text: '1 hour', onClick: (picker) => ce(picker, 60) },
          { text: '8 hours', onClick: (picker) => ce(picker, 60 * 8) },
          { text: '1 day', onClick: (picker) => ce(picker, 60 * 24) },
          { text: '1 week', onClick: (picker) => ce(picker, 60 * 24 * 7) },
          { text: '1 month', onClick: (picker) => ce(picker, 60 * 24 * 30) },
          { text: 'Always', onClick: (picker) => ce(picker, Infinity) }
        ]
      }
    }
  },
  ...
  methods: {
    makeText (muteSeconds) {
      ...
      let text = ''
      if (value === Infinity) text = 'End of the world'
